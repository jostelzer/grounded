...
- The 14-item Mediterranean Diet Adherence Screener used in trials has criterion validity for rapid dietary assessment, but it measures reported behaviour rather than the biological dose received. [Schröder et al. 2011](https://doi.org/10.3945/jn.110.135566)
...
- In pre-existing metabolic disease, 69-study pooling found modest improvements in body mass index, waist, LDL cholesterol, triglycerides, glucose, insulin resistance, and C-reactive protein, while HbA1c and lean-mass findings remained inconsistent. [Muscogiuri et al. 2026](https://doi.org/10.1016/j.nut.2025.112975)
...
- A 2025 synthesis of 11 [randomized controlled trials](https://en.wikipedia.org/wiki/Randomized_controlled_trial) found [HbA1c](https://en.wikipedia.org/wiki/Glycated_hemoglobin) −0.31 percentage points, fasting glucose −0.85 mmol/L, and [body mass index](https://en.wikipedia.org/wiki/Body_mass_index) −0.83 kg/m² versus control diets. [Wu et al. 2025](https://doi.org/10.3390/nu17243908)
...
- In contrast, the 3-y MIND trial (604 older adults; calorie-restricted intervention and control) found a global-cognition difference of 0.035 standard deviations (95% CI −0.022 to 0.092) and no meaningful MRI difference. [Barnes et al. 2023](https://doi.org/10.1056/nejmoa2302368)
...
|---|---|---|
| Major cardiovascular events | Probably reduced in higher-risk adults, especially versus minimal advice | Absolute benefit and superiority to other high-quality diets |
| Type 2 diabetes | Probably prevented; glycaemia improves modestly in established disease | Added effects of calorie restriction, activity, and intensive support |
| All-cause mortality | Consistently associated with 4% lower risk per adherence point | No mortality trial capable of confirming the cohort estimate |
| Weight and metabolic markers | Small, clinically useful changes | Not uniquely better than low-carbohydrate or low-fat diets |
| Cancer | Lower incidence/mortality associations for several sites | Mostly observational; one small secondary randomized signal |
| Cognition | Cohorts favourable; dedicated 3-y trial null | Duration, population risk, active comparator, residual confounding |
| Depression | Small trials favourable | Low certainty, high heterogeneity, weak blinding |
| Fatty liver | Liver fat improves with energy-restricted variants | Similar short-term efficacy to low-fat diets; few hard outcomes |
