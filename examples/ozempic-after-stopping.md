## When Ozempic's signal fades

*Stopping Ozempic is usually not a dramatic withdrawal event. It is a gradual return: appetite often grows louder, weight commonly comes back, and the improvements written into blood tests can fade with it—but an average curve is not a personal forecast.*

Rubino's trial investigators created the cleanest version of a question that usually unfolds messily in real life. After everyone had spent months taking semaglutide, they kept some participants on the weekly injection and switched the others to placebo. Both groups still received lifestyle support. The people who stopped began gaining weight while those who continued lost more [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224).

That split is the central fact behind the worry about stopping Ozempic, a brand of semaglutide. Yet it is not the whole answer. The strongest withdrawal trials mostly studied the higher dose used for obesity in people without diabetes, while many people taking Ozempic use a lower dose to manage diabetes. To understand what your body may do after the last injection, the science has to follow a sequence: the drug signal fades, hunger and eating can change, weight follows, and metabolic markers often change in the same direction. The question is how much of that sequence reaches any one person [Wilding et al. 2022](https://doi.org/10.1111/dom.14725), [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680), [Thomsen et al. 2025](https://doi.org/10.1111/dom.16364).

### The last injection keeps speaking

Overgaard and colleagues traced semaglutide through the body and found that its plasma concentration falls by half only after roughly a week. That means the final shot does not create a pharmacological cliff; the signal dwindles across several weeks [Overgaard et al. 2021](https://doi.org/10.1007/s40262-021-01025-x), [Blundell et al. 2017](https://doi.org/10.1111/dom.12932).

What is fading is the action of a [GLP-1 receptor agonist](https://en.wikipedia.org/wiki/Glucagon-like_peptide-1_receptor_agonist), a drug that mimics a gut hormone signal involved in appetite and glucose control. The body is not being shocked by a missing dose so much as released from an ongoing effect. Common nausea, vomiting, diarrhoea and constipation generally track active treatment and dose escalation, so they tend to ease rather than transform into a separate withdrawal syndrome. Wharton's pooled safety analysis found fewer new stomach-and-bowel events among people switched away from semaglutide, although no trial followed every symptom from the precise moment of the final injection [Wharton et al. 2022](https://doi.org/10.1111/dom.14551), [Moiz et al. 2025](https://doi.org/10.7326/annals-24-01590), [Saha et al. 2025](https://doi.org/10.1016/j.mayocp.2025.09.017).

The sequence is easiest to see as a fading signal with several delayed consequences, as shown in [Figure 1](#fig-signal-fades).

<a id="fig-signal-fades"></a>
![A warm editorial science illustration follows a fading semaglutide signal through a human profile toward returning appetite, weight regain and metabolic drift, with observed and inferred changes distinguished.](ozempic-signal-fades.png)
**Figure 1. The signal fades before its downstream effects fully show.** Semaglutide exposure declines over weeks; reduced appetite and food intake can loosen next, followed by weight regain and erosion of some blood-pressure, glucose and lipid improvements. The order is a synthesis of human pharmacology, feeding studies and withdrawal trials—not a schedule for one person's body [Overgaard et al. 2021](https://doi.org/10.1007/s40262-021-01025-x), [Blundell et al. 2017](https://doi.org/10.1111/dom.12932), [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224), [Wilding et al. 2022](https://doi.org/10.1111/dom.14725), [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680).

### Hunger gets its old volume back

Blundell's team brought people with obesity into controlled feeding sessions and watched semaglutide turn down both hunger and how much food they chose to eat. Friedrichsen's team later found the same pattern at the obesity-treatment dose: participants felt fuller and ate about a third less at a test meal [Blundell et al. 2017](https://doi.org/10.1111/dom.12932), [Friedrichsen et al. 2021](https://doi.org/10.1111/dom.14280). Oral semaglutide studies led by Gibbons and Gabe supplied another version of the same result [Gibbons et al. 2021](https://doi.org/10.1111/dom.14255), [Gabe et al. 2024](https://doi.org/10.1111/dom.15802).

Those experiments did not randomize people to stop and then measure every sandwich. Still, they point to the most direct explanation for regain: when the drug concentration falls, its appetite-dampening effect can fall too. Your stomach may empty somewhat more slowly early in treatment, but longer studies did not find a durable slowdown large enough to explain the sustained weight change. Hunger and eating, not a permanently sluggish stomach, appear to carry most of the story [Friedrichsen et al. 2021](https://doi.org/10.1111/dom.14280), [Gabe et al. 2024](https://doi.org/10.1111/dom.15802), [Saha et al. 2025](https://doi.org/10.1016/j.mayocp.2025.09.017).

Damhof and colleagues therefore describe the early post-stop period as a biological transition rather than evidence of weak willpower. But the measurements remain lopsided: scientists have carefully measured appetite while the drug is active and have far fewer direct readings after it is gone [Damhof et al. 2026](https://doi.org/10.1111/dom.71075).

### Then the weight curves part

Rubino's randomized withdrawal trial showed the curves separating within months. The people switched to placebo regained weight even though lifestyle support continued; the people who stayed on semaglutide kept losing. Crucially, the withdrawal group had not returned all the way to its starting weight by the trial's end [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224).

Wilding's team watched a different group for a full year after both semaglutide and structured lifestyle counseling ended. On average, participants regained about two-thirds of their earlier loss, but nearly half still kept a clinically meaningful reduction from baseline [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). Berg and colleagues later pooled the randomized cessation evidence and found that the amount regained tended to rise with the amount first lost [Berg et al. 2025](https://doi.org/10.1111/obr.13929).

The two direct semaglutide studies anchor [Figure 2](#fig-weight-curves); the table keeps the excess precision out of the story.

<a id="fig-weight-curves"></a>
![Two exact proportional weight-change plots compare continued versus withdrawn semaglutide in STEP 4 and treatment versus one-year withdrawal in the STEP 1 extension.](ozempic-trial-curves.png)
**Figure 2. Stopping changed the direction of the average weight curve.** In STEP 4, continued treatment and placebo withdrawal moved apart after randomization; in the STEP 1 extension, substantial regain left a smaller residual loss one year after stopping. These are group means from selected trial populations, not promised trajectories [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224), [Wilding et al. 2022](https://doi.org/10.1111/dom.14725), [Berg et al. 2025](https://doi.org/10.1111/obr.13929), [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304).

| Evidence window | Comparison | Exact weight result | Boundary |
|---|---|---|---|
| STEP 4 [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224) | 803 adults; continue 2.4 mg vs stop | −7.9% vs +6.9%; difference −14.8 points (plausible 95% range −16.0 to −13.5) | Lower doses; diabetes |
| STEP 1 extension [Wilding et al. 2022](https://doi.org/10.1111/dom.14725) | 327 completers; one year off | −17.3% treated, +11.6 points regained, −5.6% net | Continued counseling |
| GLP-1 cessation meta-analysis [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680) | 18 trials; obesity and diabetes | Obesity +5.63 kg; diabetes +2.03 kg | Personal trajectory |
| Weight-management review [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304) | 37 studies; mixed drugs | Newer incretins +0.8 kg/month | Later values modeled |

West's group gathered dozens of cessation studies and estimated faster regain after newer incretin drugs than after older weight-management medicines. Patel and Kolli reached a similar broad conclusion in separate reviews [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304), [Patel et al. 2026](https://doi.org/10.7759/cureus.111786), [Kolli et al. 2025](https://doi.org/10.7759/cureus.94926). But their longest-range answer is a forecast: the best synthesis had directly observed the newer drugs for no more than about a year after stopping. The body beyond that point is being modeled, not watched [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304).

### Blood tests follow the scale

Tzang and colleagues pooled randomized trials that continued measuring people after therapy with these drugs ended. As weight returned, waist size and blood pressure rose, while fasting glucose and [HbA1c](https://en.wikipedia.org/wiki/Glycated_hemoglobin)—a measure of average blood sugar over the preceding months—worsened on average [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680). Wilding's follow-up found the same direction: several cholesterol, inflammation and glucose improvements drifted back toward their pretreatment values, though some advantage remained while weight stayed below baseline [Wilding et al. 2022](https://doi.org/10.1111/dom.14725).

For people with diabetes, the balance may look different. The pooled trials found less weight regain than in obesity cohorts but a larger deterioration in that longer-term blood-sugar measure, and the estimate for fasting glucose was too imprecise to rule out little change. Other diabetes-care studies confirm what active semaglutide can control, but they do not turn the pooled cessation result into an Ozempic-specific prediction [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680), [Cárdenas-Salas et al. 2024](https://doi.org/10.1016/j.jdiacomp.2024.108874).

McGowan's prediabetes trial and Wilding's extension add a quieter detail. Many participants moved from prediabetes-range readings to normal glucose regulation during treatment; after withdrawal, that improvement became less common, but it did not vanish for everyone [McGowan et al. 2024](https://doi.org/10.1016/s2213-8587%2824%2900182-7), [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). The more clinically important the glucose-lowering effect was for you, the more consequential its loss may be—even when the scale changes modestly.

### The scale hides the tissue story

McCrimmon's team used [DXA](https://en.wikipedia.org/wiki/Dual-energy_X-ray_absorptiometry), an imaging method that estimates body fat and fat-free tissue, while people were taking semaglutide for diabetes. Both fat and [lean body mass](https://en.wikipedia.org/wiki/Lean_body_mass), the non-fat portion that includes muscle, organs and water, decreased [McCrimmon et al. 2020](https://doi.org/10.1007/s00125-019-05065-8). Reviews led by Karakasis, Batsis and Eisa agree that incretin-driven weight loss includes some lean tissue, although their estimates vary with the drug, population and measuring method [Karakasis et al. 2025](https://doi.org/10.1016/j.metabol.2024.156113), [Batsis et al. 2026](https://doi.org/10.7326/annals-25-00478), [Eisa & Barood 2026](https://doi.org/10.1111/dom.70666).

What happens to those compartments during regain is much less certain. Ryan, Locatelli and Bhandarkar have all examined the muscle-preservation concern, but repeated scans after semaglutide withdrawal are scarce. Claims that the returning weight is mainly fat run ahead of direct human measurements [Ryan 2025](https://doi.org/10.1007/s11154-025-09967-4), [Locatelli et al. 2024](https://doi.org/10.2337/dci23-0100), [Bhandarkar et al. 2025](https://doi.org/10.1097/med.0000000000000934). The scale can tell you that mass returned. It cannot reveal what tissue rebuilt it.

### The average is not your forecast

So does the trial average tell you what happens next? Gasoyan's team examined health records from people who used injectable semaglutide or tirzepatide in ordinary care. Unlike the clean rebound in randomized withdrawal trials, the observed weight trajectories after discontinuation looked unexpectedly stable [Gasoyan et al. 2025](https://doi.org/10.1002/oby.24331). That is the story's necessary complication, and [Figure 3](#fig-many-paths) makes it visible.

<a id="fig-many-paths"></a>
![A premium editorial evidence illustration shows one bold trial-average weight path resolving into several plausible individual paths, with a clear observed-versus-unknown distinction.](ozempic-many-paths.png)
**Figure 3. One mean curve can contain many personal paths.** Randomized trials establish average regain after withdrawal, while selected participants retain substantial loss and one real-world cohort reported stable post-stop trajectories. Researchers still cannot reliably predict who follows which path [Wilding et al. 2022](https://doi.org/10.1111/dom.14725), [Gasoyan et al. 2025](https://doi.org/10.1002/oby.24331), [Thomsen et al. 2025](https://doi.org/10.1111/dom.16364), [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224), [Aronne et al. 2024](https://doi.org/10.1001/jama.2023.24945).

The cohort does not overturn the trials. Pharmacy gaps are an imperfect marker of stopping, follow-up weights were sparse, doses were often lower, and people may have changed treatment or behavior in ways the records missed [Gasoyan et al. 2025](https://doi.org/10.1002/oby.24331). Yet the study exposes something the randomized averages cannot supply: a rule for the individual in front of the graph. Real-world reviews also find that stopping within the first year is common, so that missing rule affects many people [Thomsen et al. 2025](https://doi.org/10.1111/dom.16364). Withdrawal trials of semaglutide, liraglutide and tirzepatide agree about the average direction; they do not agree on your destination [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224), [Aronne et al. 2024](https://doi.org/10.1001/jama.2023.24945), [Jensen et al. 2024](https://doi.org/10.1016/j.eclinm.2024.102475).

### The maintenance experiment has barely begun

Lundgren's team paired supervised exercise with the related drug liraglutide, then Jensen and colleagues followed participants after treatment ended. Those who had exercised held on to more of the benefit than those who had received liraglutide alone, and the combined program also beat the drug-only path after withdrawal [Lundgren et al. 2021](https://doi.org/10.1056/nejmoa2028198), [Jensen et al. 2024](https://doi.org/10.1016/j.eclinm.2024.102475), [Jensen et al. 2022](https://doi.org/10.1038/s41467-022-32307-y). It is encouraging evidence for exercise as part of maintenance. It is not a semaglutide tapering trial.

No high-quality randomized study has yet shown that slowly stepping down semaglutide, staying on a lower dose, or adding ordinary behavioral support prevents rebound. Broad reviews have not found clear average protection from behavioral programs once medication stops, and Damhof's group treats tapering as a proposal still waiting for a proper test [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304), [Damhof et al. 2026](https://doi.org/10.1111/dom.71075).
...
**Batsis JA, Gavras A, Gross DC, Cheever CR, Da Silva BR, Meira Filho LF, Jones EP, Batchek D, Khandpekar S, Patel R, Awkal B, Pape A, Bahna M, Zamboni M, Prado CM (2026)** Effect of Incretin-Based and Nonpharmacologic Weight Loss on Body Composition. *Annals of Internal Medicine*. https://doi.org/10.7326/annals-25-00478
...
**Karakasis P, Patoulias D, Fragakis N, Mantzoros CS (2025)** Effect of glucagon-like peptide-1 receptor agonists and co-agonists on body composition: Systematic review and network meta-analysis. *Metabolism*. https://doi.org/10.1016/j.metabol.2024.156113
...
**Patel H, Babli SA, Shah S, Khambholja SH, Lingadahalli TD, Villarson C, Rizwanullah U, Kumarsivarajah S, Masood A, Rahming N, Drum Christie SS, Wallace LL, Alamu OS (2026)** Post-cessation Weight Regain After Weight Management Medications: A Systematic Review and Meta-Analysis. *Cureus*. https://doi.org/10.7759/cureus.111786
