...
*What happens when you stop taking Ozempic? Trials have followed people beyond their final dose, revealing which changes last and which begin to fade.*
...
### The first change is gradual

The molecule does not disappear as soon as an injection is missed. Yang and Yang's review of human drug-handling studies describes a long elimination half-life that supports weekly injections [Yang & Yang 2024](https://doi.org/10.2147/dddt.s470826). The half-life describes how slowly the drug clears [Yang & Yang 2024](https://doi.org/10.2147/dddt.s470826). Knudsen and Lau describe how semaglutide's reversible binding to albumin prolongs its action [Knudsen & Lau 2019](https://doi.org/10.3389/fendo.2019.00155).
...
Blundell's team offered volunteers meals and snacks they could eat freely [Blundell et al. 2017](https://doi.org/10.1111/dom.12932). During semaglutide treatment, they ate about a quarter less across those meals than during placebo treatment [Blundell et al. 2017](https://doi.org/10.1111/dom.12932). In a later experiment, Friedrichsen and colleagues found less hunger, fewer or weaker cravings and better control of eating with the obesity-treatment dose [Friedrichsen et al. 2021](https://doi.org/10.1111/dom.14280). Researchers testing oral semaglutide also found reduced food intake and appetite in adults with obesity [Gabe et al. 2024](https://doi.org/10.1111/dom.15802). A separate diabetes study found greater fullness after a fat-rich breakfast [Gibbons et al. 2021](https://doi.org/10.1111/dom.14255). A review of randomized trials of GLP-1 drugs, the class that includes semaglutide, reached the same broad conclusion about appetite suppression [Aldawsari et al. 2023](https://doi.org/10.2147/dmso.s387116).

Here, the distinction between measurement and inference matters. Blundell measured food intake during treatment [Blundell et al. 2017](https://doi.org/10.1111/dom.12932). Friedrichsen measured appetite during treatment [Friedrichsen et al. 2021](https://doi.org/10.1111/dom.14280). Their results make a return of appetite pressure after stopping plausible; they do not describe a measured day-by-day hunger curve after the final injection.

Nor does a simple story about food sitting in the stomach explain everything. At the later treatment assessment, Friedrichsen's group found no evidence of delayed gastric emptying using paracetamol absorption as an indirect test [Friedrichsen et al. 2021](https://doi.org/10.1111/dom.14280). Gabe's oral-semaglutide experiment reported the same late-treatment null finding [Gabe et al. 2024](https://doi.org/10.1111/dom.15802). Neither result rules out earlier or individual gastric effects.

### Then the paths separate

During active treatment, the weight findings are consistent. In STEP 1, Wilding and colleagues reported a mean weight change of −14.9% with semaglutide [Wilding et al. 2021](https://doi.org/10.1056/nejmoa2032183). Garvey's STEP 5 team reported a mean weight change of −15.2% with semaglutide at week 104 [Garvey et al. 2022](https://doi.org/10.1038/s41591-022-02026-4). Moiz and colleagues found substantial long-term weight loss relative to placebo [Moiz et al. 2024](https://doi.org/10.1016/j.amjcard.2024.04.041). Bergmann’s review describes similar losses across the STEP trials [Bergmann et al. 2023](https://doi.org/10.1111/dom.14863). Gudzune and Kushner’s broader medication review also found a substantial semaglutide advantage [Gudzune & Kushner 2024](https://doi.org/10.1001/jama.2024.10816).
...
Wilding's STEP 1 extension followed participants for another year after treatment ended [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). Former semaglutide recipients regained about two-thirds of their earlier loss, but still averaged less than their starting weight [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). Among participants with available follow-up data, 48.2% retained at least 5% weight loss [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). The word “regain” therefore describes a direction, not a claim that everyone returned to the beginning.
...
![Panel A contrasts continuation with withdrawal; panel B shows regain after both former treatment groups stopped.](ozempic-withdrawal-trajectory.png)
**Figure 2. Weight rises after treatment ends.** Panel A shows percent change from week-20 weight over 48 weeks after randomization. Panel B shows regain over 52 weeks after withdrawal, in percentage points (pp) of original baseline weight; its zero is the week-68 withdrawal visit. The withdrawal trial compared continuation with a placebo switch [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224). In the STEP 1 extension, medication and lifestyle support ended [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). Lines connect endpoints, not measured weekly paths. No uncertainty intervals are plotted. “Sema” means semaglutide. “Keep” denotes continuation; “Stop” denotes the placebo switch. In the STEP 1 extension, former semaglutide and placebo participants regained 11.6 and 1.9 percentage points of original baseline weight, respectively, over 52 weeks after withdrawal [Wilding et al. 2022](https://doi.org/10.1111/dom.14725).
...
|---|---|---|
| Withdrawal trial | +6.9% over 48 weeks [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224) | Lifestyle intervention continued; maintenance-dose completers |
| STEP 1 extension | 11.6 percentage points over 1 year [Wilding et al. 2022](https://doi.org/10.1111/dom.14725) | Medication and lifestyle intervention both ended |
| Newer-incretin synthesis | Monthly regain: 0.8 kg; interval 0.7–0.9 [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304) | Study-level estimate; observation no longer than 12 months |
| PCOS cohort | About one-third of prior loss regained over two years [Jensterle et al. 2024](https://doi.org/10.3389/fendo.2024.1366940) | Small uncontrolled cohort continuing metformin |

### Blood tests follow the scale

Kosiborod and colleagues examined the STEP trials beyond body weight [Kosiborod et al. 2023](https://doi.org/10.1111/dom.14890). Waist size, systolic blood pressure, fasting glucose, insulin and lipids improved during STEP 4's common treatment period, then deteriorated after the placebo switch while remaining improved with continued semaglutide [Kosiborod et al. 2023](https://doi.org/10.1111/dom.14890). In STEP 1, several benefits also moved back toward baseline after withdrawal, although some remained at the end of follow-up [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). Wilkinson's team reported a similar pattern in a calculated diabetes-risk score [Wilkinson et al. 2023](https://doi.org/10.1002/oby.23842). A calculated risk score is not an observed diagnosis.

Tzang's pooled analysis also tracked glycated haemoglobin, HbA1c [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680). It rose after GLP-1 treatment ended, with a larger average rise in the diabetes studies than in the obesity studies [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680). Variation between studies was especially large for that diabetes estimate [Tzang et al. 2025](https://doi.org/10.1016/j.eclinm.2025.103680).

These findings support moderate confidence that several metabolic improvements commonly diminish after cessation. They cannot settle the fate of every clinical benefit. Lincoff's SELECT trial found fewer major cardiovascular events with semaglutide during randomized treatment assignment [Lincoff et al. 2023](https://doi.org/10.1056/nejmoa2307563). That comparison does not directly test how long protection lasts after stopping. A change in a blood test cannot answer the missing event question.

### The prescription does not always end neatly
...
Must the average be everyone's outcome? Jensen and colleagues tested a promising complication: supervised exercise alongside liraglutide, a related GLP-1 medicine [Jensen et al. 2024](https://doi.org/10.1016/j.eclinm.2024.102475). Across the year of treatment and the year after it ended, the combination group numerically retained more weight and fat loss than the liraglutide-only group, but these comparisons did not meet the prespecified multiple-testing threshold [Jensen et al. 2024](https://doi.org/10.1016/j.eclinm.2024.102475). That total-period comparison does not isolate an advantage during the year after withdrawal. The drug was different, and follow-up was incomplete [Jensen et al. 2024](https://doi.org/10.1016/j.eclinm.2024.102475). It is an encouraging clue for semaglutide, rather than a demonstrated replacement for it.
...
McKenzie and Athinarayanan also reported maintained weight in selected patients who stopped GLP-1 treatment while continuing a carbohydrate-restricted telemedicine program [McKenzie & Athinarayanan 2024](https://doi.org/10.1007/s13300-024-01547-0). That comparison used a retrospective cohort, too [McKenzie & Athinarayanan 2024](https://doi.org/10.1007/s13300-024-01547-0).

The larger picture is less reassuring than either small cohort alone. West's synthesis found no evidence that post-cessation behavioral support changed regain rates across the included studies [West et al. 2026](https://doi.org/10.1136/bmj-2025-085304). Dash's review likewise calls for randomized testing of proposed lifestyle strategies [Dash 2024](https://doi.org/10.1111/dom.15829). Different interventions and selected populations leave room for benefit, but no broadly reliable semaglutide transition protocol emerges from these results.

### What the next trial needs to follow

Return to Rubino's two groups. Their divergent paths give strong evidence that continuing semaglutide maintains weight benefit better than withdrawing it among people who reach the study dose [Rubino et al. 2021](https://doi.org/10.1001/jama.2021.3224). The extension found regain and loss of several metabolic improvements [Wilding et al. 2022](https://doi.org/10.1111/dom.14725). The randomized metabolic analysis found deterioration after the placebo switch [Kosiborod et al. 2023](https://doi.org/10.1111/dom.14890). Together, these results support moderate confidence in a common pattern of regain and diminishing benefits.

The next useful experiment would follow people from their final semaglutide dose, randomly compare realistic maintenance strategies, and keep measuring hunger, weight and blood sugar together. It would test which people can preserve which benefits, for how long. That is the unanswered question behind the last injection.

**Scope and methods.** Narrative review; searches rerun on 4 September 2026 in PubMed, with backward and forward OpenAlex citation chasing. Focused on journal-indexed adult human evidence on semaglutide, with explicitly identified related-drug evidence and broader reviews; excluded anecdotes and preprints. The saved access manifest contains twelve authenticated full texts, eleven cited here; remaining cited material was abstract-level, including the direct STEP 4 report. Outcome confidence reflects design, bias, inconsistency, indirectness and imprecision; it is separate from whether a quotation supports a sentence. Related trial reports are grouped, and overlapping reviews are not counted as independent confirmation.
...
**Blundell J, Finlayson G, Axelsen M, Flint A, Gibbons C, Kvist T, Hjerpsted JB (2017)** Effects of once‐weekly semaglutide on appetite, energy intake, control of eating, food preference and body weight in subjects with obesity. *Diabetes, Obesity and Metabolism*. https://doi.org/10.1111/dom.12932 · 3 claims · full text
...
**Friedrichsen M, Breitschaft A, Tadayon S, Wizert A, Skovgaard D (2021)** The effect of semaglutide 2.4 mg once weekly on energy intake, appetite, control of eating, and gastric emptying in adults with obesity. *Diabetes, Obesity and Metabolism*. https://doi.org/10.1111/dom.14280 · 3 claims · full text
...
**Gasoyan H, Butsch WS, Schulte R, Casacchia NJ, Le P, Boyer CB, Griebeler ML, Burguera B, Rothberg MB (2025a)** Changes in weight and glycemic control following obesity treatment with semaglutide or tirzepatide by discontinuation status. *Obesity*. https://doi.org/10.1002/oby.24331 · 2 claims · full text
...
**McKenzie AL, Athinarayanan SJ (2024)** Impact of Glucagon-Like Peptide 1 Agonist Deprescription in Type 2 Diabetes in a Real-World Setting: A Propensity Score Matched Cohort Study. *Diabetes Therapy*. https://doi.org/10.1007/s13300-024-01547-0 · 2 claims · abstract
...
**Wilding JPH, Batterham RL, Davies M, Van Gaal LF, Kandler K, Konakli K, Lingvay I, McGowan BM, Oral TK, Rosenstock J, Wadden TA, Wharton S, Yokote K, Kushner RF, STEP 1 Study Group (2022)** Weight regain and cardiometabolic effects after withdrawal of semaglutide: The STEP 1 trial extension. *Diabetes, Obesity and Metabolism*. https://doi.org/10.1111/dom.14725 · 10 claims · full text
...
**Yang XD, Yang YY (2024)** Clinical Pharmacokinetics of Semaglutide: A Systematic Review. *Drug Design, Development and Therapy*. https://doi.org/10.2147/dddt.s470826 · 3 claims · full text

**Receipts**

*75 cited sentences · 76 source checks · 43 supported at full text · 33 at abstract · 0 partial · 0 contradicted — every pair's verbatim quote is in `ozempic-after-stopping-receipts.md`.*
