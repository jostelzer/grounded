...
**TL;DR** — School phone restrictions may help some pupils, but dependable improvements in grades or mental health remain uncertain. Confidence in these outcomes is low: studies compare different policies and measure different kinds of success.

### Less school-time use does not establish better wellbeing
...
- Lower psychological distress was associated with bans in a secondary South Australian analysis; its abstract describes the difference as small [Baggio et al. 2025](https://doi.org/10.1016/j.chb.2025.108767).
- English schools with restrictive policies showed no evidence of better mental wellbeing [Goodyear et al. 2025](https://doi.org/10.1016/j.lanepe.2025.101211).
- Dutch schools with full bans showed no detectable wellbeing or bullying advantage over classroom-only bans [Vanluydt et al. 2026](https://doi.org/10.1007/s10964-025-02313-6).
- Anxiety increased during a Hungarian mobile-free day; its brief, within-school design limits conclusions about permanent policies [Gajdics & Jagodics 2022](https://doi.org/10.1007/s10758-021-09539-w).

- [Figure 2](#fig-school-smartphone-bans-observed) compares the English study's adjusted use and wellbeing differences with their uncertainty.
