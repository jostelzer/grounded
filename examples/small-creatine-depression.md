...
- Unmedicated MDD (n=50 vs 30 controls) shows phosphocreatine and inorganic phosphate diverging between grey and white matter, with grey-matter phosphate tracking severity [Harper et al. 2017](https://doi.org/10.1038/npp.2016.180).
- Oral creatine raised frontal phosphocreatine 4.6%, 4.1% and 9.1% at 2, 4 and 10 g/day versus a 0.7% fall on placebo — clean target engagement, correlated with symptom scores (p = 0.02), no clinical advantage [Kondo et al. 2016](https://doi.org/10.1007/s00726-016-2194-3); prefrontal N-acetylaspartate and rich-club connectivity also rose in the escitalopram trial [Yoon et al. 2016](https://doi.org/10.1016/j.biopsych.2015.11.027).
- In rats, 4% dietary creatine cut forced-swim immobility in females and **increased** it in males [Allen et al. 2010](https://doi.org/10.1038/npp.2009.160) — a plausible reason the positive human trials are mostly in women.
...
- No trial has tested creatine against placebo as monotherapy in MDD, and the largest depression trial has 100 participants; powered, multi-site, sex-stratified trials running beyond 8 weeks are the missing evidence [Jeryous Fares et al. 2026](https://doi.org/10.1177/07067437251408171), [Eckert et al. 2025](https://doi.org/10.1017/s0007114525105588), [Sherpa et al. 2025](https://doi.org/10.1016/j.euroneuro.2024.10.004).
