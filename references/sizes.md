...
- **ELI5** (explicit: `eli5`, "explain like I'm five", very simple language): a connected narrative in short paragraphs and very simple English at the chosen size (defaults small). It rewrites jargon instead of applying the normal term-link pattern. It is not a bullet format unless the user explicitly asks for bullets too. Rules in "ELI5 style" in `writing-guide.md`.
