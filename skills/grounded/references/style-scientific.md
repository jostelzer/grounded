...
Write for a scientifically literate reader: precise, objective and readable. Develop the scientific explanation through connected paragraphs, specifying the exposure, comparison, outcome, design and uncertainty where they affect interpretation. Apply the reporting voice and editorial acceptance check in `writing-guide.md`.

Use the verified `synthesis.md` and outcome assessment as the factual basis. This guide adds the specialist register and article structure to the shared contract.
...
Develop a scientific point through each paragraph. Carry established context into the next sentence and explain what new evidence changes or adds. Study details serve that point; listing designs, results and limitations in succession is insufficient. Paragraph length and sentence rhythm follow the content, without a required concluding verdict.
