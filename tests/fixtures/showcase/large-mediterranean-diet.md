...
- The recurring core is vegetables, fruit, legumes, nuts, minimally refined cereals, olive oil, and fish, with less red or processed meat and sweets. Dairy, alcohol, quantities, and scoring vary; adherence scores can reward different foods or population medians [Davis et al. 2015](https://doi.org/10.3390/nu7115459), [Bach-Faig et al. 2011](https://doi.org/10.1017/s1368980011002515), [Bach et al. 2006](https://doi.org/10.1079/phn2005936), [Hutchins-Wiese et al. 2022](https://doi.org/10.1017/s0007114521002476).
- The 14-item Mediterranean Diet Adherence Screener (MEDAS) rapidly measures reported behaviour, not biological dose [Schröder et al. 2011](https://doi.org/10.3945/jn.110.135566).
- The Seven Countries Study supplied the observational hypothesis that later trials tested; it was not causal proof [Menotti & Puddu 2015](https://doi.org/10.1016/j.numecd.2014.12.001).
- Review quality varies: among 24 cardiovascular syntheses, complete compliance with adapted methodological criteria ranged from 8% to 75% [Huedo-Medina et al. 2016](https://doi.org/10.3945/ajcn.115.112771).
...
- The original 2013 PREDIMED report is retracted and is not evidence here. After a statistical audit exposed unusual baseline distributions, investigators documented household enrolment and site-level allocation departures and issued a corrected 2018 republication [Carlisle 2017](https://doi.org/10.1111/anae.13938), [Estruch et al. 2018](https://doi.org/10.1056/nejmoa1800389).
...
- Independent reviews reproduce lower cardiovascular event rates but stress that primary-prevention evidence leans heavily on PREDIMED and programmes often include counselling, free foods, or exercise [Bloomfield et al. 2016](https://doi.org/10.7326/m16-0361), [Sebastian et al. 2024](https://doi.org/10.1016/j.cpcardiol.2024.102509).
...
- Biomarker-based adherence predicted mortality better than repeated food questionnaires in an older Italian cohort, but imperfect specificity could not eliminate [confounding](https://en.wikipedia.org/wiki/Confounding) [Hidalgo-Liberona et al. 2021](https://doi.org/10.1186/s12916-021-02154-7).
...
- Across 121 trials, most named diets produced modest 6-mo losses that faded by 12 mo; Mediterranean programmes retained some cardiovascular risk-factor improvement but no unique weight-loss advantage [Ge et al. 2020](https://doi.org/10.1136/bmj.m696).
...
- Cancer meta-analyses converge on inverse observational associations, but varying scores, retrospective data, and lifestyle confounding limit causal interpretation [Schwingshackl et al. 2017](https://doi.org/10.3390/nu9101063).
...
- A 104-study mental-health review found broadly favourable associations, but only 16 studies were interventional [Kabthymer et al. 2026](https://doi.org/10.1017/s0954422425100243).
...
- An Asian-adapted trial supports transferability for fatty-liver management, but changes the tested pattern and leaves long-term outcomes unknown [Chooi et al. 2024](https://doi.org/10.1016/j.ajcnut.2023.11.013).
...
- Baseline bile acids and microbes may modify lipid and adiposity responses; PREDIMED-Plus also links diet-induced microbiome and metabolome shifts with risk factors. These are secondary analyses, not independent endpoint trials [Gao et al. 2024](https://doi.org/10.1080/19490976.2024.2426610), [García-Gavilán et al. 2024](https://doi.org/10.1016/j.ajcnut.2024.02.021).

### Translation depends on culture, cost, support, and what replaces meat or alcohol

- Outside the Mediterranean, food availability, cooking, resources, and adherence scores change; cultural adaptation is part of the intervention [Hoffman & Gerber 2013](https://doi.org/10.1111/nure.12040), [Woodside et al. 2022](https://doi.org/10.1017/s0007114522001945).
...
- Price, access, cooking skills, family norms, and knowledge impede adherence; free foods, counselling, and frequent contact make trials more supportive than routine life [Biggi et al. 2024](https://doi.org/10.3390/nu16152405).
